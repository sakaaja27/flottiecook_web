        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="editReciptForm" method="POST" action="{{ route('history.update', $recipe->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="name" name="name" value="{{ $recipe->name }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                class="form-control {{ old('category_id', $recipe->category_id) ? 'text-black' : 'text-gray-500' }}"
                                onchange="this.classList.remove('text-gray-500'); this.classList.add('text-black');">
                                <option value="" disabled {{ !$recipe->category_id ? 'selected' : '' }}>-- Pilih Kategori --</option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="description" name="description" value="{{ $recipe->description }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="tools" name="tools" value="{{ $recipe->tools }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ingredient" name="ingredient" value="{{ $recipe->ingredient }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="instruction" name="instruction" value="{{ $recipe->instruction }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        container.addEventListener("click", function (e) {
            if (e.target.closest(".add-btn")) {
                const existing = {{ $recipe->images->count() }};
