            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="editReciptForm" method="POST" action="{{ route('history.update', $recipe->id) }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="name" name="name" value="{{ $recipe->name }}" disabled
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="category_id" id="category_id" disabled
                                        ...
                                        <option value="" disabled {{ !$recipe->category_id ? 'selected' : '' }}>--
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="description" name="description"
                                        value="{{ $recipe->description }}" disabled
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tools" name="tools" value="{{ $recipe->tools }}"
                                        disabled
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="ingredient" name="ingredient"
                                        value="{{ $recipe->ingredient }}" disabled
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="instruction" name="instruction"
                                        value="{{ $recipe->instruction }}" disabled
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                </div>
                            </div>
        ...
        function handleStatusChange(status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`{{ route('history.approve', $recipe->id) }}`, {
                            method: 'POST',
                            headers: {
